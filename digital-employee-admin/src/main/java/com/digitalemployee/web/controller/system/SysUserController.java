...
import com.digitalemployee.common.core.domain.entity.SysDept;
import com.digitalemployee.common.core.domain.entity.SysRole;
...
import com.digitalemployee.common.utils.poi.ExcelUtil;
import com.digitalemployee.system.service.ISysDeptService;
import com.digitalemployee.system.service.ISysPostService;
import com.digitalemployee.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult selectList(SysUser user)
    {
    ...
    public AjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        if (StringUtils.isNotNull(userId))
        {
            ...
            sysUser.setUserDeConfig(userService.selectUserDeConfigByUserId(userId));
        }
        return ajax;
    }
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        ...
        {
            return error("新增用户'" + user.getUserName() + "'失败，用户名称已被占用，请重新输入");
        }
        ...
        // 创建 bizUser
        bizUserService.createDefaultBizUser(user, getUserId());
    ...
    public AjaxResult edit(@Validated @RequestBody SysUser user)
    {
        ...
        if (!userService.checkUserNameUnique(user))
        {
            return error("修改用户'" + user.getUserName() + "'失败，用户名称已被占用，请重新输入");
        }
        else if (StringUtils.isNotEmpty(user.getPhonenumber()) && !userService.checkPhoneUnique(user))
        {
